...
#Se requieren los números pares de la lista de 'numeros'
def num_par(numero):
    if numero % 2 == 0: #Si el modulo es 0
        return True
    

numeros_pares = list(filter(num_par,numeros))
numeros_pares.sort() #.Sort para ordenar los valores de menor a mayor// .sort(reverse=True) mayor a menor
print(numeros_pares)
